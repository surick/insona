package com.jieweifu.constants;

public class CommonConstant {
    public final static String USER_ID = "userId";
    public final static String USER_IS_ADMIN = "userIsAdmin";
    public final static String ACTION_START_TIME = "actionStartTime";
    public final static String ACTION_END_TIME = "actionEndTime";
