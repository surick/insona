...
import com.jieweifu.common.utils.BeanContext;
import com.jieweifu.models.gizwits.Gizwits_Device;
...
public class GizwitsNoti {
    ...
    private class ReceiveThread extends Thread {
        ...
        private void replyAck(JSONObject json)                  // 回复noti服务端ack
        {
            ...
            try {
                ...
                //testController.format(a);
                net.sf.json.JSONObject jsonSF = net.sf.json.JSONObject.fromObject(a);
                this.gizwitsService = BeanContext.getApplicationContext().getBean(GizwitsServiceImpl.class);
                this.gizwitsService.analysisJsonAndConserve(jsonSF);
        ...
        try {
            if (isLogin) {
                ...
                if (cmd.equals("write")) {
                    ...
                    //value="";
  ...
  //  public static void main(String[] args) {
   public void init() {
        ...
        String subkey = "demo";
        String[] events = {"device.attr_fault",
                "device.attr_alert",
                "device.online",
                "device.offline",
                "device.status.raw",
